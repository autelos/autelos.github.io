...
export declare class Transformer extends Group {
    ...
    _getNodeRect(): any;
    __getNodeShape(node: any, rot?: number, relative?: Node): {
        rotation: number;
        x: number;
        y: number;
        width: number;
    ...
    _fitNodeInto(node: Node, newAttrs: any, evt: any): void;
    forceUpdate(): void;
    update(): void;
    ...
    boundBoxFunc: GetSet<(oldBox: IRect, newBox: IRect, node: Node) => IRect, this>;
